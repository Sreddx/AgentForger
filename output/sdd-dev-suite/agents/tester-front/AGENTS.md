...
5. Surface blockers immediately — escalate to team-leader.
6. Stay within your assigned domain: tests/components/**, tests/e2e/**, cypress/**, playwright/**
...
- Escalation path: tester-front → team-leader → orchestrator → user
